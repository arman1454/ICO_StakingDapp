            ...
            poolArray.map((pool,index)=>(
              <div key={index} className={`col-12 ${index===0 || index === 1 ? "col-md-6": index===2?"":""} col-lg-4`}>
                <div className="apool">
                  ...
                  <ul className={`nav nav-tabs apool__tabs apool__tabs--${index === 0 ? "orange" : index === 1 ? "green" : index ===2 ? "blue" : "orange"}`} id={index == 0 ? "apool__tabs1" : index == 1 ? "apool__tabs2" : index == 2 ? "apool__tabs3" : ""}
                  role="tablist"
                  >
                    <li className="nav-item" role="presentation">
                      <button className="active" data-bs-toggle="tab" data-bs-target={index === 0 ? "#atab-1" : index === 1 ? "#atab-3" : index === 2 ? "#atab-5" : "" } type="button" role="tab" aria-controls={
                        index === 0 ? "atab-1" : index === 1 ? "atab-3" : index === 2 ? "atab-5" : "" 
                      } aria-selected="true">{pool.lockDays} Days</button>
                    </li>

                    <li className="nav-item" role="presentation">
                      <button data-bs-toggle="tab" data-bs-target={index === 0 ? "#atab-2" : index === 1 ? "#atab-4" : index === 2 ? "#atab-6" : ""} type="button" role="tab" aria-controls={
                  ...
                  <div className="tab-content">
                    <div className={"tab-pane fade show active"} id={index === 0 ? "atab-1" : index === 1 ? "atab-3" : index === 2 ? "atab-5" : ""} role="tabpanel">
                      <div className="apool__content">
                        ...
                        <span className="apool__value">
                          Reward: {pool?.userReward} {pool?.depositToken.symbol}
                        </span>
                      </div>
                    </div>

                    <div className="tab-pane fade" id={index === 0 ? "atab-2" : index === 1 ? "atab-4" : index === 2 ? "atab-6" : ""}
                      role="tabpanel"
                    >
                      <div className="apool__content">
                        <span className="apool__value">
                  ...
                  <div className="apool__group">
                    ...
                    placeholder={`${pool?.depositedAmount || "0"} ${pool?.depositToken.symbol}`}
                    disabled
                    />
                  </div>

                  <button className="apool__btn" data-bs-target="#modal-apool" type="button" data-bs-toggle="modal" onClick={()=>(
                  ...
                  <span className={`block-icon block-icon--${
                    index === 0 ? "orange" : index === 1 ? "green" : index === 2 ? "blue" : "orange"
                  }`}>
