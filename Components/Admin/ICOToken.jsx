...
const ICOToken = ({setLoader}) => {
  ...
  const CALLING_FUNCTION_TOKEN_WITHDRAW = async () => {
    ...
    const receipt = await UPDATE_TOKEN_PRICE()
            ...
            <div className="tab-content">
              <div className="tab-pane fade show active" id="tab-f9" role="tabpanel">
                <div className="row">
                  ...
                  <InputField size={"12"} type={"text"} title={"Address"}
                    name={"crypto"} placeholder={`${tokenDetails?.token.symbol} ${tokenDetails?.token.name}`} handleChange={(e) =>
              ...
              <div className="tab-pane fade" id="tab-f10" role="tabpanel">
                <div className="row">
                  ...
                  <InputField size={"12"} type={"text"} title={"Price"}
                    name={"price1"} placeholder={`${tokenDetails?.tokenPrice} ${CURRENCY}`} handleChange={(e) =>
              ...
              <div className="tab-pane fade" id="tab-f11" role="tabpanel">
                <div className="row">
                  ...
                  <ClickButton name={"Withdraw All Token"} handleClick={() => CALLING_FUNCTION_UPDATE_PRICE()} />
                </div>
              </div>
