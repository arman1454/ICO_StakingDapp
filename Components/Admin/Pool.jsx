            ...
            <div className="tab-content">
              <div className="tab-pane fade show active" id="tab-f6" role="tabpanel">
                  <div className="row">
                    ...
                    <InputField size={"12"} type={"text"} title={"Stake Token Address"}
                    name={"depositToken1"} placeholder = {"address"} handleChange = {(e)=>
                      setPool({...pool,_depositToken:e.target.value})
                    }
                    />
                  <InputField size={"12"} type={"text"} title={"Reward Token Address"}
                    name={"rewardToken1"} placeholder={"address"} handleChange={(e) =>
                      setPool({ ...pool, _rewardToken: e.target.value })
                    }
                  />

                  <InputField size={"6"} type={"text"} title={"APY %"}
                    name={"APY1"} placeholder={"APY"} handleChange={(e) =>
                      setPool({ ...pool, _apy: e.target.value })
                    }
                  />

                  <InputField size={"6"} type={"text"} title={"Lock Days"}
                    name={"days1"} placeholder={"days"} handleChange={(e) =>
                                ...
                                <td>
                                  <div className="deals__text deals__text--sell">
                                    <a className="header__profile" data-bs-target="#modal-apool"
                                      type="button" data-bs-toggle="modal" onClick={()=>
