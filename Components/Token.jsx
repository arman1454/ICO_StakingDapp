          ...
          <div className="col-12">
            <div className="invest invest--big">
              ...
              <p className="invest__info">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tenetur voluptatem quaerat delectus et illum ipsa eos eaque? Maiores ea error et harum ipsum quae ut dolorum voluptas, atque fugiat corrupti?
              </p>
            </div>
          </div>
        </div>
